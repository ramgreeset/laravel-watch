<form class="mb-2" action="{{ route('courses.index') }}">
    <div class="flex gap-2">
        <div class="flex-grow">
            <input type="search" name="search" placeholder="search course" value="{{request('search')}}"
        ...
        <button class="rounded-md px-4 bg-violet-500 hover:bg-violet-600">
            <x-icon name="magnifying-glass" class="size-6 fill-white"></x-icon>
        </button>
    </div>
</form>
